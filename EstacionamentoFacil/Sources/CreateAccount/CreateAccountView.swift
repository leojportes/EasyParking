...
class CreateAccountView: UIView {
   ...
   private lazy var eyeButton: UIButton = {
    ...
    private lazy var subTitleLabel: EFLabel = {
        let label = EFLabel("Informe um e-mail válido e uma senha com \n no minimo 7 digitos para criar a sua conta.",
    ...
    lazy var emailTextField: EFTextField = {
        let textField = EFTextField(titlePlaceholder: "E-mail",
    ...
    lazy var passwordTextField: EFTextField = {
    ...
    lazy var createAccountButton: EFButton = {
        let button = EFButton(title: "Criar conta",
                              colorTitle: .darkGray,
                              radius: 10,
